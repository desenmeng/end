...
var securt = '517168184b67691813000001';
...
var sha256 = function(securt,salt){
    return crypto.createHash('sha256',securt).update(salt).digest('hex');
}

var saltAndHash = function (pass, callback) {
    var salt = generateSalt();
//    callback(salt + md5(pass + salt));
    var hashpass =  md5(pass + securt);
    callback(salt+sha256(securt,salt),hashpass);
}

var validatePassword = function (plainPass, hashedPass, callback) {
    var validHash =  md5(plainPass + securt);
